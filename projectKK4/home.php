...
<section class="home">
   ...
   <div class="swiper home-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide slide" style="background:url(images/bromo.jpeg) no-repeat">
            <div class="content">
         ...
         <div class="swiper-slide slide" style="background:url(images/lombok.jpg) no-repeat">
            <div class="content">
               <span>explore, discover, travel</span>
         ...
         <div class="swiper-slide slide" style="background:url(images/lawu.jpg) no-repeat">
            <div class="content">
               <span>explore, discover, travel</span>
...
<section class="home-about">
   ...
   <div class="image">
      <img src="images/about1-img.jpg" alt="About-Us">
   </div>
...
<section class="home-offer">
   <div class="content">
      <h3>up to 25% off</h3>
      <p>If you like this page. You will have this discount!</p>
      <a href="book.php" class="btn">book now</a>
   </div>
</section>
